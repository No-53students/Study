          ...
          steps: [
            {
              ...
              description: "nums1=[1,2,3,_,_,_], nums2=[2,5,6]。先复制nums2到nums1后半部分",
            },
            {
              array: ["1", "2", "3", "2", "5", "6"],
              left: 0,
              ...
              highlights: [
                { indices: [0, 1, 2], color: "blue" as const, label: "nums1" },
                { indices: [3, 4, 5], color: "yellow" as const, label: "已复制" },
              ],
              description: "复制完成：nums1=[1,2,3,2,5,6]",
            },
            {
              array: ["1", "2", "2", "3", "5", "6"],
              left: 0,
              right: 5,
              highlights: [{ indices: [0, 1, 2, 3, 4, 5], color: "green" as const, label: "已排序" }],
              description: "对整个数组排序：[1,2,2,3,5,6]，完成！",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              highlights: [
                { indices: [0, 1, 2], color: "blue" as const, label: "nums1" },
                { indices: [4, 5, 6], color: "yellow" as const, label: "nums2" },
              ],
              description: "nums1=[1,2,3], nums2=[2,5,6]。使用临时数组temp存储结果",
            },
            {
              array: ["1"],
              left: 0,
              right: 0,
              highlights: [{ indices: [0], color: "green" as const, label: "temp" }],
              description: "比较1和2：1<2，temp=[1]，p1++",
            },
            {
              array: ["1", "2"],
              left: 0,
              right: 1,
              highlights: [{ indices: [0, 1], color: "green" as const, label: "temp" }],
              description: "比较2和2：2<=2，temp=[1,2]，p1++",
            },
            {
              array: ["1", "2", "2"],
              left: 0,
              right: 2,
              highlights: [{ indices: [0, 1, 2], color: "green" as const, label: "temp" }],
              description: "比较3和2：3>2，temp=[1,2,2]，p2++",
            },
            {
              array: ["1", "2", "2", "3", "5", "6"],
              left: 0,
              right: 5,
              highlights: [{ indices: [0, 1, 2, 3, 4, 5], color: "green" as const, label: "完成" }],
              description: "继续比较并处理剩余元素，最终temp=[1,2,2,3,5,6]",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 3,
              highlights: [],
              description: "nums=[3,2,2,3], val=3。用末尾元素覆盖要删除的元素",
            },
            {
              array: ["3", "2", "2", "3"],
              left: 0,
              right: 3,
              highlights: [{ indices: [0, 3], color: "yellow" as const, label: "检查" }],
              description: "nums[0]=3===val，用nums[3]=3覆盖，right--",
            },
            {
              array: ["3", "2", "2", "3"],
              left: 0,
              right: 2,
              highlights: [{ indices: [0, 2], color: "yellow" as const, label: "检查" }],
              description: "nums[0]=3===val（仍是3），用nums[2]=2覆盖，right--",
            },
            {
              array: ["2", "2", "2", "3"],
              left: 0,
            ...
            },
            {
              ...
              right: 1,
              highlights: [{ indices: [0, 1], color: "green" as const, label: "结果" }],
              description: "nums[1]=2≠val，left++。left>right停止，返回2",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 6,
              highlights: [],
              description: "nums=[2,2,1,1,1,2,2], n=7。统计每个元素出现次数",
            },
            {
              array: ["2:1", "2:2", "1:1", "1:2", "1:3"],
              left: 0,
              right: 4,
              highlights: [{ indices: [0, 1], color: "blue" as const, label: "2" }],
              description: "遍历中：map={2:2, 1:3}...",
            },
            {
              array: ["2", "2", "1", "1", "1", "2", "2"],
              left: 0,
              right: 6,
              highlights: [{ indices: [0, 1, 5, 6], color: "green" as const, label: "2出现4次" }],
              description: "最终：2出现4次 > 7/2=3.5 ✓ 返回2",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 6,
              highlights: [],
              description: "nums=[2,2,1,1,1,2,2], n=7。排序后多数元素必在中间位置",
            },
            {
              array: ["1", "1", "1", "2", "2", "2", "2"],
              left: 0,
              right: 6,
              highlights: [{ indices: [0, 1, 2, 3, 4, 5, 6], color: "blue" as const, label: "排序" }],
              description: "排序后：[1,1,1,2,2,2,2]",
            },
            {
              array: ["1", "1", "1", "2", "2", "2", "2"],
              left: 3,
              right: 3,
              highlights: [{ indices: [3], color: "green" as const, label: "中间位置" }],
              description: "中间位置 n/2=3，nums[3]=2。多数元素必覆盖此位置，返回2",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 4,
              highlights: [],
              description: "nums=[1,2,3,4,5], k=2。计算每个元素的新位置",
            },
            {
              array: ["_", "_", "1", "2", "3"],
              left: 2,
              right: 4,
              highlights: [{ indices: [2, 3, 4], color: "blue" as const, label: "移动" }],
              description: "前3个元素：i=0→(0+2)%5=2, i=1→3, i=2→4",
            },
            {
              array: ["4", "5", "1", "2", "3"],
              left: 0,
              ...
              description: "后2个元素：i=3→0, i=4→1。结果=[4,5,1,2,3]",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 4,
              highlights: [],
              description: "nums=[1,2,3,4,5], k=2。形成替换链",
            },
            {
              array: ["1", "2", "1", "4", "5"],
              left: 0,
              right: 2,
              highlights: [{ indices: [0, 2], color: "yellow" as const, label: "0→2" }],
              description: "start=0: 1从位置0移到位置2",
            },
            {
              array: ["1", "2", "1", "4", "3"],
              left: 2,
              right: 4,
              highlights: [{ indices: [2, 4], color: "yellow" as const, label: "2→4" }],
              description: "被替换的3从位置2移到位置4",
            },
            {
              array: ["5", "2", "1", "4", "3"],
              left: 0,
              right: 4,
              highlights: [{ indices: [0, 4], color: "yellow" as const, label: "4→1→0" }],
              description: "5→位置1→位置0。第一个环结束",
            },
            {
              array: ["4", "5", "1", "2", "3"],
              left: 0,
              right: 4,
              highlights: [{ indices: [0, 1, 2, 3, 4], color: "green" as const, label: "完成" }],
              description: "start=1开始第二个环，完成后=[4,5,1,2,3]",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              left: 0,
              right: 0,
              highlights: [{ indices: [0], color: "blue" as const, label: "day0" }],
              description: "prices=[7,1,5,3,6,4]。初始：dp0=0(不持有), dp1=-7(持有)",
            },
            {
              array: ["dp0=0", "dp1=-1"],
              left: 0,
              right: 1,
              highlights: [{ indices: [1], color: "green" as const, label: "更新" }],
              description: "day1: dp0=max(0,-1+1)=0, dp1=max(-7,-1)=-1。发现更低价",
            },
            {
              array: ["dp0=4", "dp1=-1"],
              left: 0,
              right: 1,
              highlights: [{ indices: [0], color: "yellow" as const, label: "卖出" }],
              description: "day2: dp0=max(0,-1+5)=4, dp1=max(-1,-5)=-1。可卖出赚4",
            },
            {
              array: ["dp0=5", "dp1=-1"],
              left: 0,
              right: 1,
              highlights: [{ indices: [0], color: "green" as const, label: "最优" }],
              description: "day4: dp0=max(4,-1+6)=5。最大利润=5！",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 0,
              highlights: [{ indices: [0], color: "blue" as const, label: "day0" }],
              description: "prices=[7,1,5,3,6,4]。初始：dp0=0, dp1=-7",
            },
            {
              array: ["dp0=0", "dp1=-1"],
              left: 0,
              right: 1,
              highlights: [{ indices: [1], color: "green" as const, label: "更新" }],
              description: "day1: dp1=max(-7,0-1)=-1。发现更好的买入点",
            },
            {
              array: ["dp0=4", "dp1=-1"],
              left: 0,
              right: 1,
              highlights: [{ indices: [0], color: "yellow" as const, label: "卖出" }],
              description: "day2: dp0=max(0,-1+5)=4。卖出获利4",
            },
            {
              array: ["dp0=4", "dp1=1"],
              left: 0,
              right: 1,
              highlights: [{ indices: [1], color: "blue" as const, label: "再买入" }],
              description: "day3: dp1=max(-1,4-3)=1。用利润再买入！",
            },
            {
              array: ["dp0=7", "dp1=1"],
              left: 0,
              right: 1,
              highlights: [{ indices: [0], color: "green" as const, label: "最优" }],
              description: "day4: dp0=max(4,1+6)=7。再次卖出，总利润=7",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 4,
              highlights: [],
              description: "nums=[2,3,1,1,4]。dp[i]表示能否到达位置i，dp=[T,?,?,?,?]",
            },
            {
              array: ["T", "?", "?", "?", "?"],
              left: 0,
              right: 1,
              highlights: [{ indices: [0], color: "green" as const, label: "可达" }],
              description: "检查i=1: dp[0]=T, 0+2>=1 ✓ 所以dp[1]=T",
            },
            {
              array: ["T", "T", "?", "?", "?"],
              left: 0,
              right: 2,
              highlights: [{ indices: [0, 1], color: "green" as const, label: "可达" }],
              description: "检查i=2: dp[0]=T, 0+2>=2 ✓ 所以dp[2]=T",
            },
            {
              array: ["T", "T", "T", "T", "T"],
              left: 0,
              right: 4,
              highlights: [{ indices: [0, 1, 2, 3, 4], color: "green" as const, label: "全可达" }],
              description: "继续检查...dp=[T,T,T,T,T]。dp[4]=T，返回true",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              left: 0,
              right: 0,
              highlights: [{ indices: [0], color: "blue" as const, label: "第0层" }],
              description: "nums=[2,3,1,1,4]。BFS：第0层=[0,0]，jumps=0",
            },
            {
              array: ["2", "3", "1", "1", "4"],
              left: 0,
              right: 2,
              highlights: [
                { indices: [0], color: "gray" as const, label: "已探" },
                { indices: [1, 2], color: "blue" as const, label: "第1层" },
              ],
              description: "从第0层扩展：maxEnd=max(0,0+2)=2。第1层=[1,2]，jumps=1",
            },
            {
              array: ["2", "3", "1", "1", "4"],
              left: 1,
              ...
              highlights: [
                { indices: [0], color: "gray" as const, label: "已探" },
                { indices: [1, 2], color: "yellow" as const, label: "探索中" },
                { indices: [3, 4], color: "blue" as const, label: "第2层" },
              ],
              description: "从第1层扩展：i=1时maxEnd=4，i=2时maxEnd=4。第2层=[3,4]，jumps=2",
            },
            {
              array: ["2", "3", "1", "1", "4"],
              left: 0,
              right: 4,
              highlights: [{ indices: [0, 1, 2, 3, 4], color: "green" as const, label: "到达" }],
              description: "end=4>=n-1=4，到达终点！最少需要2次跳跃",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 4,
              highlights: [],
              description: "citations=[3,0,6,1,5], n=5。统计每个引用数的论文数量",
            },
            {
              array: ["1", "1", "0", "1", "0", "2"],
              left: 0,
              right: 5,
              highlights: [{ indices: [0, 1, 2, 3, 4, 5], color: "blue" as const, label: "count" }],
              description: "count[0]=1, count[1]=1, count[3]=1, count[5]=2(含6)。从右往左累计",
            },
            {
              array: ["i=5", "total=2"],
              left: 0,
              right: 1,
              highlights: [{ indices: [1], color: "yellow" as const, label: "检查" }],
              description: "i=5: total=2 < 5，不满足",
            },
            {
              array: ["i=3", "total=3"],
              left: 0,
              right: 1,
              highlights: [{ indices: [1], color: "green" as const, label: "满足" }],
              description: "i=4: total=2<4。i=3: total=3>=3 ✓ H指数=3",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 3,
              highlights: [],
              description: "nums=[1,2,3,4]。用left[]存左侧乘积，right[]存右侧乘积",
            },
            {
              array: ["1", "1", "2", "6"],
              left: 0,
              right: 3,
              highlights: [{ indices: [0, 1, 2, 3], color: "blue" as const, label: "left[]" }],
              description: "计算left[]: left=[1,1,2,6]。left[i]=nums[0..i-1]的乘积",
            },
            {
              array: ["24", "12", "4", "1"],
              left: 0,
              right: 3,
              highlights: [{ indices: [0, 1, 2, 3], color: "yellow" as const, label: "right[]" }],
              description: "计算right[]: right=[24,12,4,1]。right[i]=nums[i+1..n-1]的乘积",
            },
            {
              array: ["24", "12", "8", "6"],
              left: 0,
              right: 3,
              highlights: [{ indices: [0, 1, 2, 3], color: "green" as const, label: "结果" }],
              description: "answer[i]=left[i]*right[i]: [1*24, 1*12, 2*4, 6*1]=[24,12,8,6]",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 5,
              highlights: [],
              description: "height=[4,2,0,3,2,5]。维护单调递减栈，横向计算水量",
            },
            {
              array: ["4", "2", "0", "3", "2", "5"],
              left: 0,
              right: 2,
              highlights: [{ indices: [0, 1, 2], color: "blue" as const, label: "入栈" }],
              description: "i=0,1,2: 栈=[0,1,2] (高度4,2,0递减)",
            },
            {
              array: ["4", "2", "0", "3", "2", "5"],
              left: 2,
              right: 3,
              highlights: [
                { indices: [2], color: "red" as const, label: "凹槽底" },
                { indices: [1, 3], color: "green" as const, label: "边界" },
              ],
              description: "i=3: height[3]=3>height[2]=0，弹出2。左=1,右=3,宽=1,高=2。水+=2",
            },
            {
              array: ["4", "2", "0", "3", "2", "5"],
              left: 1,
              right: 3,
              highlights: [
                { indices: [1], color: "red" as const, label: "凹槽底" },
                { indices: [0, 3], color: "green" as const, label: "边界" },
              ],
              description: "继续: height[3]=3>height[1]=2，弹出1。左=0,右=3,宽=2,高=1。水+=2，共4",
            },
            {
              array: ["4", "2", "0", "3", "2", "5"],
              left: 0,
          ...
          steps: [
            {
              ...
              right: 5,
              highlights: [],
              description: "height=[4,2,0,3,2,5]。预计算leftMax和rightMax数组",
            },
            {
              array: ["4", "4", "4", "4", "4", "5"],
              left: 0,
              right: 5,
              highlights: [{ indices: [0, 1, 2, 3, 4, 5], color: "blue" as const, label: "leftMax" }],
              description: "leftMax=[4,4,4,4,4,5]。每个位置左边(含自己)的最大高度",
            },
            {
              array: ["5", "5", "5", "5", "5", "5"],
              left: 0,
              right: 5,
              highlights: [{ indices: [0, 1, 2, 3, 4, 5], color: "yellow" as const, label: "rightMax" }],
              description: "rightMax=[5,5,5,5,5,5]。每个位置右边(含自己)的最大高度",
            },
            {
              array: ["0", "2", "4", "1", "2", "0"],
              left: 0,
              right: 5,
              highlights: [{ indices: [1, 2, 3, 4], color: "green" as const, label: "接水" }],
              description: "water[i]=min(leftMax,rightMax)-height: [0,2,4,1,2,0]。总和=9",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 6,
              highlights: [],
              description: "s='MCMXCIV'。先替换6种特殊组合为单个字符",
            },
            {
              array: ["M", "f", "X", "C", "I", "V"],
              left: 0,
              right: 5,
              highlights: [{ indices: [1], color: "yellow" as const, label: "CM→f" }],
              description: "替换CM为f(900): 'MfXCIV'",
            },
            {
              array: ["M", "f", "d", "I", "V"],
              left: 0,
              right: 4,
              highlights: [{ indices: [2], color: "yellow" as const, label: "XC→d" }],
              description: "替换XC为d(90): 'MfdIV'",
            },
            {
              array: ["M", "f", "d", "a"],
              left: 0,
              right: 3,
              highlights: [{ indices: [3], color: "yellow" as const, label: "IV→a" }],
              description: "替换IV为a(4): 'Mfda'",
            },
            {
              array: ["1000", "900", "90", "4"],
              left: 0,
              right: 3,
              highlights: [{ indices: [0, 1, 2, 3], color: "green" as const, label: "累加" }],
              description: "直接累加: 1000+900+90+4 = 1994",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 0,
              highlights: [{ indices: [0], color: "blue" as const, label: "num" }],
              description: "num=1994。拆分为千/百/十/个位，直接查表",
            },
            {
              array: ["1", "9", "9", "4"],
              left: 0,
              right: 3,
              highlights: [{ indices: [0, 1, 2, 3], color: "blue" as const, label: "拆分" }],
              description: "拆分: 千位=1, 百位=9, 十位=9, 个位=4",
            },
            {
              array: ["M", "CM", "XC", "IV"],
              left: 0,
              right: 3,
              highlights: [{ indices: [0, 1, 2, 3], color: "green" as const, label: "查表" }],
              description: "查表: thousands[1]=M, hundreds[9]=CM, tens[9]=XC, ones[4]=IV",
            },
            {
              array: ["M", "C", "M", "X", "C", "I", "V"],
              left: 0,
              right: 6,
              highlights: [{ indices: [0, 1, 2, 3, 4, 5, 6], color: "green" as const, label: "拼接" }],
              description: "拼接结果: MCMXCIV",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 10,
              highlights: [],
              description: "s='Hello World'。使用内置函数处理",
            },
            {
              array: ["Hello", "World"],
              left: 0,
              right: 1,
              highlights: [{ indices: [0, 1], color: "blue" as const, label: "分割" }],
              description: "trim().split(' '): ['Hello', 'World']",
            },
            {
              array: ["Hello", "World"],
              left: 1,
              right: 1,
              highlights: [{ indices: [1], color: "green" as const, label: "最后" }],
              description: "取最后一个: 'World'",
            },
            {
              array: ["W", "o", "r", "l", "d"],
              left: 0,
              right: 4,
              highlights: [{ indices: [0, 1, 2, 3, 4], color: "green" as const, label: "长度5" }],
              description: "'World'.length = 5",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 2,
              highlights: [],
              description: "strs=['flower','flow','flight']。逐列比较",
            },
            {
              array: ["f-lower", "f-low", "f-light"],
              left: 0,
              right: 2,
              highlights: [{ indices: [0, 1, 2], color: "green" as const, label: "i=0" }],
              description: "i=0: 比较第0列: 'f'=='f'=='f' ✓",
            },
            {
              array: ["fl-ower", "fl-ow", "fl-ight"],
              left: 0,
              right: 2,
              highlights: [{ indices: [0, 1, 2], color: "green" as const, label: "i=1" }],
              description: "i=1: 比较第1列: 'l'=='l'=='l' ✓",
            },
            {
              array: ["flo-wer", "flo-w", "fli-ght"],
              left: 0,
              right: 2,
              highlights: [
                { indices: [0, 1], color: "green" as const, label: "o" },
                { indices: [2], color: "red" as const, label: "i" },
              ],
              description: "i=2: 比较第2列: 'o'=='o'!='i' ✗ 停止",
            },
            {
              array: ["fl", "fl", "fl"],
              left: 0,
          ...
          steps: [
            {
              ...
              right: 2,
              highlights: [],
              description: "strs=['flower','flow','flight']。分治：分成两半递归求解",
            },
            {
              array: ["flower", "flow", "|", "flight"],
              left: 0,
              right: 3,
              highlights: [
                { indices: [0, 1], color: "blue" as const, label: "左半" },
                { indices: [3], color: "yellow" as const, label: "右半" },
              ],
              description: "分割: 左=['flower','flow'], 右=['flight']",
            },
            {
              array: ["flow", "|", "flight"],
              left: 0,
              right: 2,
              highlights: [
                { indices: [0], color: "green" as const, label: "左LCP" },
                { indices: [2], color: "green" as const, label: "右LCP" },
              ],
              description: "递归: 左LCP='flow', 右LCP='flight'",
            },
            {
              array: ["flow", "flight"],
              left: 0,
              right: 1,
              highlights: [{ indices: [0, 1], color: "blue" as const, label: "合并" }],
              description: "合并: LCP('flow','flight')",
            },
            {
              array: ["fl"],
              left: 0,
              ...
              description: "'flow'与'flight'的公共前缀='fl'。最终结果='fl'",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              left: 0,
              right: 6,
              highlights: [{ indices: [6], color: "blue" as const, label: "right" }],
              description: "s='the sky'。从末尾开始，right=6",
            },
            {
              array: ["t", "h", "e", " ", "s", "k", "y"],
              left: 4,
              right: 6,
              highlights: [
                { indices: [4], color: "green" as const, label: "left+1" },
                { indices: [6], color: "green" as const, label: "right" },
              ],
              description: "找到单词边界: left=3(空格), right=6。提取'sky'",
            },
            {
              array: ["t", "h", "e", " ", "s", "k", "y"],
              left: 0,
              right: 2,
              highlights: [
                { indices: [4, 5, 6], color: "gray" as const, label: "已提取" },
                { indices: [0, 1, 2], color: "green" as const, label: "the" },
              ],
              description: "right=2, left=-1。提取'the'。result='sky the'",
            },
            {
              array: ["s", "k", "y", " ", "t", "h", "e"],
              left: 0,
              right: 6,
              highlights: [{ indices: [0, 1, 2, 3, 4, 5, 6], color: "green" as const, label: "结果" }],
              description: "最终结果: 'sky the'",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 6,
              highlights: [],
              description: "s='the sky'。步骤：1.去空格 2.整体反转 3.逐词反转",
            },
            {
              array: ["y", "k", "s", " ", "e", "h", "t"],
              left: 0,
              right: 6,
              highlights: [{ indices: [0, 1, 2, 3, 4, 5, 6], color: "blue" as const, label: "整体反转" }],
              description: "步骤2: 整体反转 → 'yks eht'",
            },
            {
              array: ["s", "k", "y", " ", "e", "h", "t"],
              left: 0,
              right: 2,
              highlights: [{ indices: [0, 1, 2], color: "green" as const, label: "反转sky" }],
              description: "步骤3: 反转第一个单词 'yks' → 'sky'",
            },
            {
              array: ["s", "k", "y", " ", "t", "h", "e"],
              left: 4,
              right: 6,
              highlights: [
                { indices: [0, 1, 2], color: "gray" as const, label: "已完成" },
                { indices: [4, 5, 6], color: "green" as const, label: "反转the" },
              ],
              description: "反转第二个单词 'eht' → 'the'。最终: 'sky the'",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 3,
              highlights: [],
              description: "nums=[3,4,-1,1], n=4。用符号标记存在性",
            },
            {
              array: ["3", "4", "5", "1"],
              left: 0,
              right: 3,
              highlights: [{ indices: [2], color: "yellow" as const, label: "-1→5" }],
              description: "步骤1: 将无效数改为n+1。-1→5",
            },
            {
              array: ["-3", "4", "-5", "-1"],
              left: 0,
              right: 3,
              highlights: [
                { indices: [0], color: "green" as const, label: "1存在" },
                { indices: [2], color: "green" as const, label: "3存在" },
                { indices: [3], color: "green" as const, label: "4存在" },
              ],
              description: "步骤2: 遍历，将nums[x-1]变负。1,3,4存在",
            },
            {
              array: ["-3", "4", "-5", "-1"],
              left: 1,
              right: 1,
              highlights: [{ indices: [1], color: "red" as const, label: "正数" }],
              description: "步骤3: nums[1]=4>0，说明2不存在。返回2",
            },
          ] as TwoPointersStep[],
        },
      },
          ...
          steps: [
            {
              ...
              right: 8,
              highlights: [],
              description: "s='ababcbaca'。将每个字母看作区间[首次,最后]",
            },
            {
              array: ["a:[0,8]", "b:[1,5]", "c:[4,7]"],
              left: 0,
              right: 2,
              highlights: [
                { indices: [0], color: "blue" as const, label: "a" },
                { indices: [1], color: "green" as const, label: "b" },
                { indices: [2], color: "yellow" as const, label: "c" },
              ],
              description: "计算区间: a:[0,8], b:[1,5], c:[4,7]",
            },
            {
              array: ["[0,8]", "[1,5]", "[4,7]"],
              left: 0,
              right: 2,
              highlights: [{ indices: [0, 1, 2], color: "gray" as const, label: "已排序" }],
              description: "按起始位置排序(已有序): [0,8],[1,5],[4,7]",
            },
            {
              array: ["[0,8]", "[1,5]", "[4,7]"],
              left: 0,
              right: 2,
              highlights: [
                { indices: [0], color: "green" as const, label: "当前" },
                { indices: [1], color: "yellow" as const, label: "合并" },
              ],
              description: "[1,5]在[0,8]内，合并→[0,8]",
            },
            {
              array: ["[0,8]", "[4,7]"],
              left: 0,
              ...
              description: "[4,7]在[0,8]内，合并→[0,8]",
            },
            {
              array: ["[0,8]"],
              left: 0,
              ...
              description: "合并后只剩[0,8]，长度=9。结果:[9]",
            },
          ] as TwoPointersStep[],
        },
        timeComplexity: "O(n)",
